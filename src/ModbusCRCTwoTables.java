public class ModbusCRCTwoTables {

    public static byte[] aCRCHi = {
    ...
    public static int computeModbusCRC(byte[] data) {
        int uchCRCHi = 0xFF;
        int uchCRCLo = 0xFF;

        for (byte b : data) {
            int uIndex = uchCRCLo ^ (b & 0xFF);
            uchCRCLo = uchCRCHi ^ (aCRCHi[uIndex] & 0xFF);
            uchCRCHi = aCRCLo[uIndex] & 0xFF;
        }
